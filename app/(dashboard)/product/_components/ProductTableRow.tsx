        ...
        <tr className="hover:bg-gray-50">
            <td className="px-3 py-3 sm:px-4 sm:py-3">
                <div className="flex items-center gap-2 sm:gap-3">
                    <div className="h-10 w-10 sm:h-12 sm:w-12 shrink-0 rounded-lg overflow-hidden bg-gray-100">
                        {variantImage ? (
                            <Image
                                src={variantImage}
                                alt={product.name}
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="min-w-[140px] sm:min-w-[160px]">
                        <DropdownMenuItem asChild>
                            <Link href={`/product/${product.id}/view`} className="text-xs sm:text-sm">View</Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href={`/product/${product.id}/edit`} className="text-xs sm:text-sm">Edit</Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href={`/product/${product.id}/variants`} className="text-xs sm:text-sm">Variants</Link>
                        </DropdownMenuItem>
                        <DropdownMenuSeparator />
                        {/* <DropdownMenuItem
                            variant="destructive"
