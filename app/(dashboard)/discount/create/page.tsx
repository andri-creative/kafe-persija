...
export default function DiscountCreatePage() {
    ...
    function validate() {
        ...
        if (!form.type) return "Type must be selected.";
        ...
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center animate-in fade-in zoom-in duration-500">
                ...
                <p className="text-slate-500 max-w-sm mb-8 font-medium">
                    You don't have enough permission to create discounts. 
            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-5">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-slate-900 tracking-tight leading-none uppercase">Add Discount</h1>
                            <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest font-bold">
                                Create new discount for products/categories
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
                    <form onSubmit={handleSubmit} className="divide-y divide-gray-50 text-slate-800">

                        {/* Section: Info */}
                        <div className="px-5 py-5 space-y-4">
                            <p className="text-[11px] font-black text-gray-400 uppercase tracking-wider">Discount Information</p>

                            <Field label="Discount Name" hint="*Required">
                                <input className={ic} placeholder="e.g., Member Special 10%"
                        ...
                        <div className="px-6 py-6 space-y-5">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-[10px] font-black text-slate-800 uppercase tracking-wider">Status</p>
                            </div>
                            <div className="grid grid-cols-2 gap-3">
                                {[
