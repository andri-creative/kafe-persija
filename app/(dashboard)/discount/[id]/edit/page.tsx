            ...
            <div className="max-w-2xl mx-auto p-4 sm:p-6 space-y-5">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-in fade-in slide-in-from-top-4 duration-500">
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h1 className="text-xl font-black text-slate-900 tracking-tight leading-none">Edit Diskon</h1>
                            <p className="text-[10px] text-slate-500 mt-1 uppercase tracking-widest font-bold">
                                {form.name || "Memperbarui diskon..."}
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="divide-y divide-gray-50">
                        ...
                        <div className="px-6 py-6 space-y-5">
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <p className="text-[10px] font-black text-slate-800 uppercase tracking-wider">Informasi Dasar</p>
                            </div>

                            <Field label="Nama Diskon" hint="*Wajib">
                                <input className={ic + " text-xs font-bold uppercase placeholder:italic"} placeholder="Contoh: Diskon Member 10%"
                                    value={form.name} onChange={(e) => setForm({ ...form, name: e.target.value })} />
                            </Field>

                            <Field label="Keterangan / Deskripsi" hint="(opsional)">
